...
const postSchema = z.object({
  ...
  image: z.any()
    .refine((file) => file instanceof FileList, "Preview image is required")
    .refine((file) => file[0]?.size <= 5000000, "Image cannot exceed 5MB"),
  content: z.string()
...
function CreatePost() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await apiInstance.post("admin/post-create/", formData, {
        headers: {
      ...
      <div className="row justify-content-center">
        <div className="col-lg-10">
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h2 className="mb-1">Create New Post</h2>
              <p className="text-muted">Fill out the form to create your post</p>
            </div>
            <button
              ...
              <div className="card-body">
                ...
                <div className="mb-4">
                  <label className="form-label d-block">
                    ...
                    <small className="text-muted ms-2">This image will be shown as the main image of your post</small>
                  </label>
                  <img
